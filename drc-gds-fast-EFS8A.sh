...
# magicGdrc -T $PDKPATH/libs.tech/magic/$VERSION/EFS8A.tech -I vendorimport -S 'drc(full)' -l $OUT_DIR/$2.drc.out -km $OUT_DIR/$2.drc.km ../$GDS_FILE_PATH $CELL_NAME

magicGdrc -T $PDKPATH/libs.tech/magic/$VERSION/EFS8A.tech -I vendorimport -S 'drc(fast)' -l $2.drc.out -km $2.drc.km ../$GDS_FILE_PATH $CELL_NAME

...
cd $PROJECT/elec
elec2spi -o lmi814A_22oct2020.spie -LP -TS -NTI lmi814l.delib lmi814A_22oct2020.sch >& elec2spi.lmi814A_22oct2020.log


 ;# in the ./elec as it uses the elec preferences
